...
<body>
            ...
            <div class="profile-info">
                <div class="editable-field-group">
                    ...
                    <span class="edit-mode-input">
                        <input type="text" id="editAthleteName" value="" placeholder="Nome Completo do Atleta">
                    </span>
                </div>
                ...
                <div class="editable-field-group">
                    ...
                    <span class="edit-mode-input">
                        <input type="text" id="editUsername" value="" placeholder="nome_do_atleta">
                    </span>
                </div>
    ...
    <div id="commentModal" class="modal comment-modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3>Comentários</h3>
                <span class="close-button" id="closeCommentModalBtn">&times;</span>
            </div>
            <div class="modal-body">
                <ul id="commentList" class="comment-list">
                    </ul>
                <div class="comment-input-area">
                    <input type="text" id="newCommentInput" placeholder="Adicionar um comentário...">
